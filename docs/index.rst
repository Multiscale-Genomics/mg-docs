...
`mg-rest-file <http://mg-rest-file.readthedocs.io>`_
   ...
   `GitHub mg-rest-file <https://github.com/Multiscale-Genomics/mg-rest-file>`_
...
`mg-rest-adjacency <http://mg-rest-adjacency.readthedocs.io>`_
   ...
   workflows developed in `mg-process-fastq <https://github.com/Multiscale-Genomics/mg-process-fastq>`__.
...
`mg-rest-3d <http://mg-rest-3d.readthedocs.io>`_
   ...
   workflows developed in `mg-process-files <https://github.com/Multiscale-Genomics/mg-process-files>`__.
...
`mg-rest-util <http://mg-rest-util.readthedocs.io>`_
   ...
   `GitHub mg-rest-util <https://github.com/Multiscale-Genomics/mg-rest-util>`_
